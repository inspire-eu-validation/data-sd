...
The Data Specification on Species Distribution – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Species Distribution.

The specification specifies the following conformance classes:

| Conformance class | Standardization target |
| ----------------- | ---------------------- |
| [GML application schemas, Species Distribution](http://inspire.ec.europa.eu/id/ats/data-sd/3.0/sd-gml) | INSPIRE spatial data set encoded in GML, Species Distribution features |
| [Application Schema, Species Distribution](http://inspire.ec.europa.eu/id/ats/data-sd/3.0/sd-as) | INSPIRE spatial data set |
| [Reference Systems, Species Distribution](http://inspire.ec.europa.eu/id/ats/data-sd/3.0/sd-rs) | INSPIRE spatial data set |
| [Data Consistency, Species Distribution](http://inspire.ec.europa.eu/id/ats/data-sd/3.0/sd-dc) | INSPIRE spatial data set |
| [Information Accessibility, Species Distribution](http://inspire.ec.europa.eu/id/ats/data-sd/3.0/sd-ia) | INSPIRE spatial data set |
| [Portrayal, Species Distribution](http://inspire.ec.europa.eu/id/ats/data-sd/3.0/sd-portrayal) | INSPIRE view service |
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Species Distribution - Core", are not needed as no feature instance can be of a type from that application schema.
