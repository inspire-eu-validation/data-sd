...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/sd/4.0/SpeciesDistribution.xsd, using strict XML schema validation.
